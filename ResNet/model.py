...
class ResidualBlock2(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride=1, downsample=None):
        ...
        self.conv1 = nn.Conv2d(in_channels, out_channels, kernel_size=1, stride=1, bias=False)  # squeeze channels
        self.bn1 = nn.BatchNorm2d(out_channels)
...
class ResNet(nn.Module):
    ...
    def _make_layer(self, block, channel, blocks_num, stride=1):  # channel为每层中第一层的卷积核个数
        ...
        layers = [block(self.in_channels, channel, stride=stride, downsample=downsample)]
...
def resnet18(num_classes=1000, include_top=True):
    return ResNet(ResidualBlock1, [2, 2, 2, 2], num_classes, include_top)


def resnet34(num_classes=1000, include_top=True):
    return ResNet(ResidualBlock1, [3, 4, 6, 3], num_classes, include_top)
...
def resnet152(num_classes=1000, include_top=True):
    return ResNet(ResidualBlock2, [3, 8, 36, 3], num_classes, include_top)
